...
describe('Controller Tests', function() {
    ...
    describe('Project Management Detail Controller', function() {
        var $scope, $rootScope;
        var MockEntity, MockPreviousState, MockProject, MockCompetence, MockCompDomain, MockUserDashboard;
        ...
        describe('Root Scope Listening', function() {
            it('Unregisters root scope listener upon scope destruction', function() {
                var eventType = 'jhipsterElasticsearchSampleApplicationApp:projectUpdate';
