...
class ProjectGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Project entity")
        ...
        .repeat(2) {
            ...
            .post("/api/projects")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "title":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "image":null, "creationDate":"2020-01-01T00:00:00.000Z", "completionDate":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
